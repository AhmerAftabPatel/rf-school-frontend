...
export default function Admissions({admissions,curriculum}) {
  return (
    <div>
      ...
      />
      <SmallHeader heading={admissions.page} description='Welcome from the Admission Office' banner={admissions.banner}/>
      <Headerstyle>
        <IntroAdmissions admissions={admissions}/>
        <br/>
        {/* <HtmlDynamic data={admissions}/> */}
        <AcademicsInfo type='general' curriculum={curriculum} mobile={false}/>
      </Headerstyle>
      <Footer />
    </div>
  );

module.exports = {
  ...
  AccordiionData: [
    ...
    { name: 'Summer School' },
    { name: 'School Tour' },
    // { name: 'Stem Integrated Education' },
  ...
  news_events: [
    { title: 'Lorem Ippsum News 1', description: 'Lorem ipsum is placeholder text commonly used in the graphic' },
    { title: 'Lorem Ippsum News 1', description: 'Lorem ipsum is placeholder text commonly used in the graphic' },
    { title: 'Lorem Ippsum News 1', description: 'Lorem ipsum is placeholder text commonly used in the graphic' },
  ],
  home_tools : [
    {label : "Online Admission Form", href : "/admission-form",icon : "/images/icons/checklist.png", color : "red"},
    {label : "Online Tuition Payment", href : "/online-tuition-payment",icon : "/images/icons/cashless-payment.png", color : "blue"},
